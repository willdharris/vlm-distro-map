...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/destination.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.destinationArray = void 0;
var destinationArray;
exports.destinationArray = destinationArray;

function processFiles(handleFiles) {
  handleFiles.preventDefault();
  var files = handleFiles.target.files || handleFiles.dataTransfer.files;
  ...
  if (destFile) {
    ...
    fileReader.onload = function (el) {
      var data = el.target.result;
      var workbook = XLSX.read(data, {
        type: "binary"
      });
      workbook.SheetNames.forEach(function (sheet) {
        exports.destinationArray = destinationArray = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheet]);
...
},{}],"src/expiration.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.expirationArray = void 0;
var expirationArray; // export const expSheet = document.getElementById("file-uploader-update");
...
exports.expirationArray = expirationArray;

function processFilesUpdate(handleFilesUpdate) {
  handleFilesUpdate.preventDefault();
  var files = handleFilesUpdate.target.files || handleFilesUpdate.dataTransfer.files;
  var updateFile = files[0];
  ...
  if (updateFile) {
    ...
    fileReader.onload = function (el) {
      ...
      workbook.SheetNames.forEach(function (sheet) {
        exports.expirationArray = expirationArray = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheet]);
        console.log(expirationArray);
        return expirationArray;
      });
    };
...
document.getElementById("file-drop-update").addEventListener("drop", processFilesUpdate);
document.getElementById("file-drop-update").addEventListener("change", processFilesUpdate);
},{}],"node_modules/carbon-components/es/globals/js/settings.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./evented-state":"node_modules/carbon-components/es/globals/js/mixins/evented-state.js","../misc/get-launching-details":"node_modules/carbon-components/es/globals/js/misc/get-launching-details.js"}],"node_modules/warning/browser.js":[function(require,module,exports) {
/**
...
},{}],"node_modules/carbon-components/es/globals/js/mixins/track-blur.js":[function(require,module,exports) {
"use strict";
      ...
      if (state === 'shown') {
        ...
        if (!this.element.hasAttribute(this.options.attribAvoidFocusOnOpen)) {
          ...
          if (primaryFocusNode) {
            ...
            if ("development" !== "production") {
              "development" !== "production" ? (0, _warning.default)(focusableNode === null, 'Floating Menus must have at least a programmatically focusable child. ' + 'This can be accomplished by adding tabindex="-1" to the content element.') : void 0;
            }
          }
        }
      }
...
exports.default = _default;
},{"warning":"node_modules/warning/browser.js","../../globals/js/misc/mixin":"node_modules/carbon-components/es/globals/js/misc/mixin.js","../../globals/js/settings":"node_modules/carbon-components/es/globals/js/settings.js","../../globals/js/mixins/create-component":"node_modules/carbon-components/es/globals/js/mixins/create-component.js","../../globals/js/mixins/evented-show-hide-state":"node_modules/carbon-components/es/globals/js/mixins/evented-show-hide-state.js","../../globals/js/mixins/handles":"node_modules/carbon-components/es/globals/js/mixins/handles.js","../../globals/js/mixins/track-blur":"node_modules/carbon-components/es/globals/js/mixins/track-blur.js","../../globals/js/misc/get-launching-details":"node_modules/carbon-components/es/globals/js/misc/get-launching-details.js","../../globals/js/misc/resize":"node_modules/carbon-components/es/globals/js/misc/resize.js","../../globals/js/misc/on":"node_modules/carbon-components/es/globals/js/misc/on.js"}],"node_modules/carbon-components/es/components/overflow-menu/overflow-menu.js":[function(require,module,exports) {
"use strict";
    ...
    value: function _changeState(state, detail, callback) {
      ...
      var transitionEnd = function transitionEnd() {
        ...
        if (state === 'shown' && _this2.element.offsetWidth > 0 && _this2.element.offsetHeight > 0) {
          ...
          if ("development" !== "production") {
            "development" !== "production" ? (0, _warning.default)(focusableItem, "Modals need to contain a focusable element by either using " + "`".concat(_this2.options.selectorPrimaryFocus, "` or settings.selectorTabbable.")) : void 0;
          }
        }
...
exports.default = _default;
},{"../../globals/js/settings":"node_modules/carbon-components/es/globals/js/settings.js","../../globals/js/misc/mixin":"node_modules/carbon-components/es/globals/js/misc/mixin.js","../../globals/js/mixins/create-component":"node_modules/carbon-components/es/globals/js/mixins/create-component.js","../../globals/js/mixins/init-component-by-search":"node_modules/carbon-components/es/globals/js/mixins/init-component-by-search.js","../../globals/js/mixins/handles":"node_modules/carbon-components/es/globals/js/mixins/handles.js","../../globals/js/misc/on":"node_modules/carbon-components/es/globals/js/misc/on.js"}],"node_modules/carbon-components/es/components/data-table/data-table.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../data-table/data-table":"node_modules/carbon-components/es/components/data-table/data-table.js"}],"node_modules/flatpickr/dist/flatpickr.js":[function(require,module,exports) {
var define;
...
exports.default = _default;
},{"../../globals/js/settings":"node_modules/carbon-components/es/globals/js/settings.js","../../globals/js/misc/mixin":"node_modules/carbon-components/es/globals/js/misc/mixin.js","../../globals/js/mixins/create-component":"node_modules/carbon-components/es/globals/js/mixins/create-component.js","../../globals/js/mixins/init-component-by-search":"node_modules/carbon-components/es/globals/js/mixins/init-component-by-search.js","../../globals/js/mixins/handles":"node_modules/carbon-components/es/globals/js/mixins/handles.js","../../globals/js/misc/event-matches":"node_modules/carbon-components/es/globals/js/misc/event-matches.js","../../globals/js/misc/on":"node_modules/carbon-components/es/globals/js/misc/on.js"}],"node_modules/carbon-components/es/globals/js/mixins/init-component-by-event.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/carbon-components/es/components/tooltip/tooltip--simple.js":[function(require,module,exports) {
"use strict";
...
var _tooltipSimple = _interopRequireDefault(require("../../components/tooltip/tooltip--simple"));
...
function mapIDs() {
  if (!_destination.destinationArray || !_expiration.expirationArray) {
    alert("Please upload both a destination report and asset update file.");
  }

  document.getElementById("destination").innerHTML += _destination.destinationArray[0].Destination;

  var operation = function operation(expirationArray, destinationArray) {
    var isUnion = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    return expirationArray.filter(function (a) {
      return isUnion === destinationArray.some(function (b) {
        return a.HDP === b["Package Asset ID"];
      });
    });
  };

  var inBoth = function inBoth(expirationArray, destinationArray) {
    return operation(expirationArray, destinationArray, true);
  };

  var atDestination = inBoth(_expiration.expirationArray, _destination.destinationArray);
  ...
  if (atDestination.length === 0) {
    document.getElementById("site").innerHTML += "None of these assets are at the destination.";
  } else {
...
_carbonComponents.FileUploader.create(document.getElementById("destreport"));

_carbonComponents.FileUploader.create(document.getElementById("updatelist"));

var submit = document.getElementById("findSameIDs");
submit.addEventListener("click", mapIDs);
},{"./destination":"src/destination.js","./expiration":"src/expiration.js","carbon-components":"node_modules/carbon-components/es/index.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
